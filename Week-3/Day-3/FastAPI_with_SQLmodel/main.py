...
from FastAPI_with_SQLmodel.api.route import master_router
...
from FastAPI_with_SQLmodel.api.schemas.shipment import ShipmentCreate, ShipmentRead, ShipmentUpdate
